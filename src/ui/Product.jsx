function Product({ img, quantity, price, title, subtitle }) {
  return (
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center gap-10">
          ...
          <div className="flex h-12 w-24 items-center justify-center border-1 border-gray-400">
            <button className="h-full cursor-pointer border-r-1 border-gray-400 p-1">
            ...
            <button className="h-full cursor-pointer border-l-1 border-gray-400 p-1">
